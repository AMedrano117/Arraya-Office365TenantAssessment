...
| Email domains to migrate | 4 custom domain(s): lvhndemo.cavehousebrewing.com, jeffersondemo.cavehousebrewing.com, lab.com, cavehousebrewing.com |
...
- Primary migration review items: Teams workload data (Needs Data); Directory synchronization (Review); Voice workload readiness (Needs Data); Mail routing (Review); Cross-tenant and B2B settings (Review); Hybrid or coexistence indicators (Review).
- Current assessment findings to review: B2B management policy not found; external identity settings may be default/unconfigured License 'MCOPSTN1' has 0 remaining (fully allocated) License 'Office 365 E3' has 0 remaining (fully allocated) 5 OneDrive sites exceed 1024 GB
