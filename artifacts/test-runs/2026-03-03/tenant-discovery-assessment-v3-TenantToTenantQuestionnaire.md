...
| Does your organization utilize Microsoft Copilot? | Not detected in discovered license inventory. |
| Does your organization utilize Copilot Studio? | Likely yes for Copilot Studio; matched license(s): CCI Bots Private Preview (3/10000 consumed) |
...
| Does your organization use Power Pages? | Not detected in discovered license inventory. |
...
| Discovery Item | Answer |
|---------------|--------|
| Microsoft Viva | Not detected in discovered license inventory. |
| Microsoft Forms | Not detected in discovered license inventory. |
...
| Microsoft Stream | Not detected in discovered license inventory. |
...
- Primary migration review items: Teams workload data (Needs Data); Guests and external identities (Review); Voice workload readiness (Needs Data); Mail flow dependencies (Review); Directory synchronization (Review); Hybrid or coexistence indicators (Review).
- Current assessment findings to review: Partial hybrid indicators detected without full configuration (review mail flow connectors and org settings) 32 devices (78%) are stale (inactive > 6 months) B2B management policy not found; external identity settings may be default/unconfigured Device compliance is only 0% (target: 80%)
