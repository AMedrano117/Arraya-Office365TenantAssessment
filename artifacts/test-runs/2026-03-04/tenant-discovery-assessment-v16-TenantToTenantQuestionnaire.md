...
| Email domains to migrate | 4 custom domain(s): lab.com, lvhndemo.cavehousebrewing.com, cavehousebrewing.com, jeffersondemo.cavehousebrewing.com |
...
- Primary migration review items: Public folders (Review); Guests and external identities (Review); Hybrid or coexistence indicators (Review); Directory synchronization (Review); Mail routing (Review); Cross-tenant and B2B settings (Review).
- Current assessment findings to review: 108 SharePoint sites exceed 1024 GB Domain 'lab.com' is not verified License 'Office 365 E3' has 0 remaining (fully allocated) Microsoft Secure Score is 39.8%, which is below the target range for a mature tenant baseline.
