...
| Email domains to migrate | 4 custom domain(s): jeffersondemo.cavehousebrewing.com, lab.com, cavehousebrewing.com, lvhndemo.cavehousebrewing.com |
...
- Primary migration review items: Mail flow dependencies (Review); Mail routing (Review); Guests and external identities (Review); Teams workload data (Needs Data); Voice workload readiness (Needs Data); Verified custom domains (Blocker).
- Current assessment findings to review: Domain 'lab.com' is not verified 108 SharePoint sites exceed 1024 GB License 'SPE_E5' has 0 remaining (fully allocated) 32 devices (78%) are stale (inactive > 6 months)
