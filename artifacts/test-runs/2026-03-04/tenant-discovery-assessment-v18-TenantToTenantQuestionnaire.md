...
| Email domains to migrate | 4 custom domain(s): cavehousebrewing.com, jeffersondemo.cavehousebrewing.com, lvhndemo.cavehousebrewing.com, lab.com |
...
- Primary migration review items: Teams workload data (Needs Data); Mail routing (Review); Voice workload readiness (Needs Data); Directory synchronization (Review); Mail flow dependencies (Review); Guests and external identities (Review).
- Current assessment findings to review: Domain 'lab.com' is not verified License 'MCOPSTN1' has 0 remaining (fully allocated) License 'SPE_E5' has 0 remaining (fully allocated) License 'POWERAPPS_PER_USER' has 0 remaining (fully allocated)
