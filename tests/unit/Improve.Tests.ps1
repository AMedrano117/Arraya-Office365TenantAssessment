Describe 'Improve workflow' {
    ...
    It 'generates normalized findings, customer deliverables, and fixed remediation snippets' {
        ...
        $customerReportDocument | Should -Match '2\.1 Assessment Methodology'
        $customerReportDocument | Should -Match 'Data Collection Scope'
        $customerReportDocument | Should -Match 'Workloads Not in Scope'
        ...
        $customerReportDocument | Should -Match 'Coverage by User Type'
        $customerReportDocument | Should -Match 'Admin users registered for MFA'
        $customerReportDocument | Should -Match 'Conditional Access Policy Configuration'
        $customerReportDocument | Should -Match 'Guest \/ external-user Conditional Access coverage'
        ...
        $customerReportDocument | Should -Match 'coverage tables above show enforcement by user type'
        ...
        $customerReportDocument | Should -Match '13\.0 Email Authentication and Domain Configuration'
        $customerReportDocument | Should -Match '14\.0 Offboarding Recommendation'
        $customerReportDocument | Should -Match '15\.0 Workloads Outside Assessment Scope'
        $customerReportDocument | Should -Match '16\.0 Appendix'
        ...
        $roadmapDocument | Should -Match 'Criticality'
    ...
    It 'uses grouped distinct workstreams for the overall findings chart and emits the companion roadmap deliverable' {
        ...
        $customerDocxSource | Should -Match 'New-CustomerWordParagraphBlock.*\$title.*-Style ''Heading3'''
    ...
    It 'derives MFA enrollment output from registration details when summary objects are missing' {
        ...
        $customerReportText | Should -Match 'All enabled users'
        $customerReportText | Should -Match 'Member users'
        $customerReportText | Should -Match 'coverage tables above show enforcement by user type'
