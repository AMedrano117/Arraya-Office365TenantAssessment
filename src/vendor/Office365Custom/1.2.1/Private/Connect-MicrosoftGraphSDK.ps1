    ...
    .DESCRIPTION
        Establishes a Microsoft Graph SDK connection using delegated, application, or certificate-based authentication.
        This private helper supports Graph-specific connection flows used by the Office365Custom module.
    .PARAMETER WriteGraph
        Indicates graph connection with write permissions.
    .PARAMETER Force
        Forces re-authentication.
    .EXAMPLE
        Connect-MicrosoftGraphSDK -WriteGraph
    #>
