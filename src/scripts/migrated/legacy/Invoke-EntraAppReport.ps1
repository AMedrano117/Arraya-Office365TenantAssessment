...
if (-not $hasAllPerms -or ($state -and $state.TenantId -ne '62d3324b-368b-4afc-8df0-a7c23388fc8b')) {
    try {
        ...
        Connect-MgGraph -TenantId '62d3324b-368b-4afc-8df0-a7c23388fc8b' -Scopes $requiredPerms -ErrorAction Stop -NoWelcome
