...
| Email domains to migrate | 4 custom domain(s): cavehousebrewing.com, lab.com, jeffersondemo.cavehousebrewing.com, lvhndemo.cavehousebrewing.com |
...
- Primary migration review items: Hybrid or coexistence indicators (Review); Voice workload readiness (Needs Data); Directory synchronization (Review); Mail flow dependencies (Review); Public folders (Review); Teams workload data (Needs Data).
- Current assessment findings to review: 108 SharePoint sites exceed 1024 GB License 'MCOPSTN1' has 0 remaining (fully allocated) 32 devices (78%) are stale (inactive > 6 months) License 'Office 365 E3' has 0 remaining (fully allocated)
